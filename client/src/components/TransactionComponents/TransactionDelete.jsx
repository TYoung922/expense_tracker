...
const DeleteTransactionForm = () => {
  ...
  const { mutate: deleteTr, isLoading: TransactionDelete } =
    useTrasactionDelete();
  ...
  return (
    <div className={styles.container}>
              ...
              <div key={index} className={styles.container}>
                <div className={styles.deleteContainer}>
                  <TransactionCard
                    ...
                    money={tr.money}
                    // description={${tr. id}tit <= :${tr.tit <= }${tr. e fo}}
                  ...
                  <button
                    ...
                    style={
                      transactionsLoading
                        ? { pointerEvents: "none", background: "#333" }
                        : {}
                    }
                    onClick={() => {
                      console.log(tr.id);
      ...
      {(transactionsLoading || TransactionDelete || transactionsRefetching) && (
        <Spinner fullPage />
      )}
    </div>
  );
