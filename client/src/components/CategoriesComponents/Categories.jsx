      ...
      <div className={styles.filters}>
        <div className={styles.filterContainer}>
          ...
          <div className={styles.filter}>
            <lavel htmlFor="timeSpan">Time Span:</lavel>
            <select
              name="timeSpan"
              onChange={(e) => {
            ...
            >
              ...
              <option value={DateTime.now().minus({ days: 28 }).toISODate()}>
                Last 28 days
              </option>
              ...
              <option value={DateTime.now().minus({ years: 5 }).toISODate()}>
                Last 5 years
              </option>
            </select>
          </div>
